...
public FileResult<AndroidFileIO> resolve(Emulator<AndroidFileIO> emulator, String pathname, int oflags) {
    if (pathname.equals("/data/app/com.sdu.didi.gsui-mGlj-PzyfIpeLiDCnY-Qcw==/base.apk")) {
        File file = new File("D:\\unidbg\\unidbg-0.9.8\\unidbg-android\\src\\test\\java\\com\\sdu\\didi\\gsui\\滴滴车主.apk");
    ...
    private void installInstrumentation() {
        traceHooks.add(emulator.traceWrite(0x122b1cf9L, (0x122b1cf9L + 32L)));
        traceHooks.add(emulator.traceWrite(0x122b3ba8L, (0x122b3ba8L + 8L)));
            traceAiStartRangeWriteProbe("rw_src_dd04", 0x122b1cf9L, (0x122b1cf9L + 32L), traceAiRangeJson(0x122b1cf9L, (0x122b1cf9L + 32L), "fixed"));
            traceAiStartRangeWriteProbe("rw_slot_dd04_ptr", 0x122b3ba8L, (0x122b3ba8L + 8L), traceAiRangeJson(0x122b3ba8L, (0x122b3ba8L + 8L), "fixed"));
    }
