package agent.generated.case_cff_e2e_64a065f56a;
...
public FileResult<AndroidFileIO> resolve(Emulator<AndroidFileIO> emulator, String pathname, int oflags) {
    ...
    private void installInstrumentation() {
        traceAiInstallBreakpoint("bp_concat_input", "memoryReadOnBreakpoint", (0x120021fcL - module.base), Arm64Const.UC_ARM64_REG_X25, "x25", new RegisterSpec[] {new RegisterSpec("x25", Arm64Const.UC_ARM64_REG_X25)}, 81, "memoryReadOnBreakpoint", 0L, 0L);
        traceAiInstallBreakpoint("bp_newstringutf_output", "memoryReadOnBreakpoint", (0x12001ed0L - module.base), Arm64Const.UC_ARM64_REG_X1, "x1", new RegisterSpec[] {new RegisterSpec("x1", Arm64Const.UC_ARM64_REG_X1)}, 108, "memoryReadOnBreakpoint", 0L, 0L);
    }
