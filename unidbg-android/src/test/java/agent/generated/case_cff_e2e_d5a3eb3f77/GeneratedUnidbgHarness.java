package agent.generated.case_cff_e2e_d5a3eb3f77;
...
private void startTraceHooks() {
    stopTraceHooks();
    traceHooks.add(emulator.traceCodeText(module.base, module.base + module.size, "D:\\project\\TraceAIagent_v3\\workspace\\unidbg-script-agent\\case-cff-e2e-d5a3eb3f77\\runs\\apply-1\\trace\\obs_trace_code_full_module.trace.log"));
}
