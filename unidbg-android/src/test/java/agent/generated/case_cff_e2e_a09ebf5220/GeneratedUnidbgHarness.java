package agent.generated.case_cff_e2e_a09ebf5220;
...
public FileResult<AndroidFileIO> resolve(Emulator<AndroidFileIO> emulator, String pathname, int oflags) {
    ...
    private void installInstrumentation() {
        traceAiInstallRegisterMemoryProbe("obs_regmem_in_b64b", (0x120036c8L - module.base), false, new RegisterMemoryProbeSpec("obs_regmem_in_b64b", "", "", Arm64Const.UC_ARM64_REG_X26, "x26", 81, 0, "", 4096), new RegisterSpec[] {new RegisterSpec("x0", Arm64Const.UC_ARM64_REG_X0), new RegisterSpec("x1", Arm64Const.UC_ARM64_REG_X1), new RegisterSpec("x2", Arm64Const.UC_ARM64_REG_X2), new RegisterSpec("x3", Arm64Const.UC_ARM64_REG_X3), new RegisterSpec("x4", Arm64Const.UC_ARM64_REG_X4), new RegisterSpec("x5", Arm64Const.UC_ARM64_REG_X5), new RegisterSpec("x6", Arm64Const.UC_ARM64_REG_X6), new RegisterSpec("x7", Arm64Const.UC_ARM64_REG_X7), new RegisterSpec("lr", Arm64Const.UC_ARM64_REG_LR), new RegisterSpec("sp", Arm64Const.UC_ARM64_REG_SP), new RegisterSpec("pc", Arm64Const.UC_ARM64_REG_PC)});
        traceAiInstallRegisterMemoryProbe("obs_regmem_out_nsu3", (0x12001c44L - module.base), false, new RegisterMemoryProbeSpec("obs_regmem_out_nsu3", "", "", Arm64Const.UC_ARM64_REG_X1, "x1", 108, 0, "", 4096), new RegisterSpec[] {new RegisterSpec("x0", Arm64Const.UC_ARM64_REG_X0), new RegisterSpec("x1", Arm64Const.UC_ARM64_REG_X1), new RegisterSpec("x2", Arm64Const.UC_ARM64_REG_X2), new RegisterSpec("x3", Arm64Const.UC_ARM64_REG_X3), new RegisterSpec("x4", Arm64Const.UC_ARM64_REG_X4), new RegisterSpec("x5", Arm64Const.UC_ARM64_REG_X5), new RegisterSpec("x6", Arm64Const.UC_ARM64_REG_X6), new RegisterSpec("x7", Arm64Const.UC_ARM64_REG_X7), new RegisterSpec("lr", Arm64Const.UC_ARM64_REG_LR), new RegisterSpec("sp", Arm64Const.UC_ARM64_REG_SP), new RegisterSpec("pc", Arm64Const.UC_ARM64_REG_PC)});
    }
