package agent.generated.case_unidbg_001_cff;
...
public class GeneratedUnidbgHarness extends AbstractJni implements IOResolver<AndroidFileIO> {
    ...
    public GeneratedUnidbgHarness() throws IOException {
        ...
        // source-position traceCode 将在 run() 中按调用插入点启动。
        try {
...
public FileResult<AndroidFileIO> resolve(Emulator<AndroidFileIO> emulator, String pathname, int oflags) {
    ...
    private void installInstrumentation() {
        traceAiInstallBreakpoint("bp_hex_table_30f4", "memoryReadOnBreakpoint", (0x120030f4L - module.base), Arm64Const.UC_ARM64_REG_X0, "UC_ARM64_REG_X0", new RegisterSpec[] {new RegisterSpec("x0", Arm64Const.UC_ARM64_REG_X0), new RegisterSpec("x1", Arm64Const.UC_ARM64_REG_X1), new RegisterSpec("x2", Arm64Const.UC_ARM64_REG_X2), new RegisterSpec("x3", Arm64Const.UC_ARM64_REG_X3), new RegisterSpec("x4", Arm64Const.UC_ARM64_REG_X4), new RegisterSpec("x5", Arm64Const.UC_ARM64_REG_X5), new RegisterSpec("x6", Arm64Const.UC_ARM64_REG_X6), new RegisterSpec("x7", Arm64Const.UC_ARM64_REG_X7), new RegisterSpec("lr", Arm64Const.UC_ARM64_REG_LR), new RegisterSpec("sp", Arm64Const.UC_ARM64_REG_SP), new RegisterSpec("pc", Arm64Const.UC_ARM64_REG_PC)}, 16, "memoryReadOnBreakpoint", 0L, 0x1200065dL);
        traceAiInstallBreakpoint("bp_hex_input_30e8", "memoryReadOnBreakpoint", (0x120030e8L - module.base), Arm64Const.UC_ARM64_REG_X0, "UC_ARM64_REG_X0", new RegisterSpec[] {new RegisterSpec("x0", Arm64Const.UC_ARM64_REG_X0), new RegisterSpec("x1", Arm64Const.UC_ARM64_REG_X1), new RegisterSpec("x2", Arm64Const.UC_ARM64_REG_X2), new RegisterSpec("x3", Arm64Const.UC_ARM64_REG_X3), new RegisterSpec("x4", Arm64Const.UC_ARM64_REG_X4), new RegisterSpec("x5", Arm64Const.UC_ARM64_REG_X5), new RegisterSpec("x6", Arm64Const.UC_ARM64_REG_X6), new RegisterSpec("x7", Arm64Const.UC_ARM64_REG_X7), new RegisterSpec("lr", Arm64Const.UC_ARM64_REG_LR), new RegisterSpec("sp", Arm64Const.UC_ARM64_REG_SP), new RegisterSpec("pc", Arm64Const.UC_ARM64_REG_PC)}, 16, "memoryReadOnBreakpoint", 0L, 0xe4fff608L);
        traceAiInstallBreakpoint("bp_hex_output_done_3620", "memoryReadOnBreakpoint", (0x12003620L - module.base), Arm64Const.UC_ARM64_REG_X0, "UC_ARM64_REG_X0", new RegisterSpec[] {new RegisterSpec("x0", Arm64Const.UC_ARM64_REG_X0), new RegisterSpec("x1", Arm64Const.UC_ARM64_REG_X1), new RegisterSpec("x2", Arm64Const.UC_ARM64_REG_X2), new RegisterSpec("x3", Arm64Const.UC_ARM64_REG_X3), new RegisterSpec("x4", Arm64Const.UC_ARM64_REG_X4), new RegisterSpec("x5", Arm64Const.UC_ARM64_REG_X5), new RegisterSpec("x6", Arm64Const.UC_ARM64_REG_X6), new RegisterSpec("x7", Arm64Const.UC_ARM64_REG_X7), new RegisterSpec("lr", Arm64Const.UC_ARM64_REG_LR), new RegisterSpec("sp", Arm64Const.UC_ARM64_REG_SP), new RegisterSpec("pc", Arm64Const.UC_ARM64_REG_PC)}, 32, "memoryReadOnBreakpoint", 0L, 0xe4fff5e4L);
    }
