package agent.generated.fuxian_run;
...
public class GeneratedUnidbgHarness extends AbstractJni implements IOResolver<AndroidFileIO> {
    ...
    private static final String APK_FILE_PATH = "D:\\project\\TraceAIagent_v3\\workspace\\manual-inputs\\fuxian\\滴滴车主.apk";
    private static final String SO_FILE_PATH = "D:\\project\\TraceAIagent_v3\\workspace\\manual-inputs\\fuxian\\libdidiwsg.so";
    ...
    public String run() {
        ...
        DvmObject<?> securityLibObject = vm.resolveClass("com.didi.security.wireless.SecurityLib").newObject(null);
        Object null_arg = null;

        securityLibObject.callJniMethodObject(emulator, "nativeInit(Landroid/content/Context;)I", context);
        securityLibObject.callJniMethodObject(emulator, "nativeUpdate(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nativeUpdate_str, null, null, null);
        securityLibObject.callJniMethodObject(emulator, "nativeUpdate2(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", null, null, null, nativeUpdate2_str);
        securityLibObject.callJniMethodObject(emulator, "nativeCollect(Ljava/lang/String;)Ljava/lang/String;", nativeCollect_str);

        DvmObject<?> object1 = securityLibObject.callJniMethodObject(emulator, "nativeSig(Landroid/content/Context;JLjava/lang/String;[B)Ljava/lang/String;", context, arg1_timestamp, arg2_phone, arg3_payload);
        return traceAiStringifyResult(object1.getValue().toString());
    }
...
public FileResult<AndroidFileIO> resolve(Emulator<AndroidFileIO> emulator, String pathname, int oflags) {
    if (pathname.equals("/data/app/com.sdu.didi.gsui-mGlj-PzyfIpeLiDCnY-Qcw==/base.apk")) {
        File file = new File("D:\\project\\TraceAIagent_v3\\workspace\\manual-inputs\\fuxian\\滴滴车主.apk");
