package agent.generated.traceaibase64unidbgscript;
...
public class GeneratedUnidbgHarness extends AbstractJni implements IOResolver<AndroidFileIO> {
    ...
    private static final String SO_FILE_PATH = "D:\\project\\TraceAIagent_v3\\tests\\base64_unidbg\\libs\\arm64-v8a\\libtraceai_base64_standard.so";
    private static final String PROCESS_NAME = "com.traceai.base64";
    ...
    public String run() {
        StringObject plaintextString = new StringObject(vm, "TraceAI standard base64");



        startTraceHooks();
        try {
            DvmObject<?> result = vm.resolveClass("com/traceai/base64/Base64Native").callStaticJniMethodObject(emulator, "encode(Ljava/lang/String;)Ljava/lang/String;", plaintextString);
...
public FileResult<AndroidFileIO> resolve(Emulator<AndroidFileIO> emulator, String pathname, int oflags) {
    ...
    private void installInstrumentation() {
        traceAiInstallBreakpoint("analysis-20260617-230913-176843-analysis-alphabet-table-read", "memoryReadOnBreakpoint", 0xba4L, Arm64Const.UC_ARM64_REG_X8, "x8", new RegisterSpec[] {new RegisterSpec("x0", Arm64Const.UC_ARM64_REG_X0), new RegisterSpec("x1", Arm64Const.UC_ARM64_REG_X1), new RegisterSpec("x2", Arm64Const.UC_ARM64_REG_X2), new RegisterSpec("x3", Arm64Const.UC_ARM64_REG_X3), new RegisterSpec("x4", Arm64Const.UC_ARM64_REG_X4), new RegisterSpec("x5", Arm64Const.UC_ARM64_REG_X5), new RegisterSpec("x6", Arm64Const.UC_ARM64_REG_X6), new RegisterSpec("x7", Arm64Const.UC_ARM64_REG_X7), new RegisterSpec("lr", Arm64Const.UC_ARM64_REG_LR), new RegisterSpec("sp", Arm64Const.UC_ARM64_REG_SP), new RegisterSpec("pc", Arm64Const.UC_ARM64_REG_PC)}, 64, "memoryReadOnBreakpoint", 0L, 0L);
        traceAiInstallCallsiteProbe("analysis-20260617-230913-176843-analysis-sub9f4-callsite", 0x8ecL, false, 0x8f0L, false, new RegisterSpec[] {new RegisterSpec("x0", Arm64Const.UC_ARM64_REG_X0), new RegisterSpec("x1", Arm64Const.UC_ARM64_REG_X1), new RegisterSpec("x2", Arm64Const.UC_ARM64_REG_X2), new RegisterSpec("x3", Arm64Const.UC_ARM64_REG_X3), new RegisterSpec("x4", Arm64Const.UC_ARM64_REG_X4), new RegisterSpec("x5", Arm64Const.UC_ARM64_REG_X5), new RegisterSpec("x6", Arm64Const.UC_ARM64_REG_X6), new RegisterSpec("x7", Arm64Const.UC_ARM64_REG_X7), new RegisterSpec("lr", Arm64Const.UC_ARM64_REG_LR), new RegisterSpec("sp", Arm64Const.UC_ARM64_REG_SP), new RegisterSpec("pc", Arm64Const.UC_ARM64_REG_PC)}, new RegisterMemoryProbeSpec[] {new RegisterMemoryProbeSpec("analysis-20260617-230913-176843-analysis-sub9f4-input-read", "analysis-20260617-230913-176843-analysis-sub9f4-callsite", "enter", Arm64Const.UC_ARM64_REG_X0, "x0", 23, 0, "", 4096)}, new RegisterMemoryProbeSpec[] {});
        traceAiInstallCallsiteProbe("analysis-20260617-230913-176843-analysis-newstringutf-callsite", 0x910L, false, 0x914L, false, new RegisterSpec[] {new RegisterSpec("x0", Arm64Const.UC_ARM64_REG_X0), new RegisterSpec("x1", Arm64Const.UC_ARM64_REG_X1), new RegisterSpec("x2", Arm64Const.UC_ARM64_REG_X2), new RegisterSpec("x3", Arm64Const.UC_ARM64_REG_X3), new RegisterSpec("x4", Arm64Const.UC_ARM64_REG_X4), new RegisterSpec("x5", Arm64Const.UC_ARM64_REG_X5), new RegisterSpec("x6", Arm64Const.UC_ARM64_REG_X6), new RegisterSpec("x7", Arm64Const.UC_ARM64_REG_X7), new RegisterSpec("lr", Arm64Const.UC_ARM64_REG_LR), new RegisterSpec("sp", Arm64Const.UC_ARM64_REG_SP), new RegisterSpec("pc", Arm64Const.UC_ARM64_REG_PC)}, new RegisterMemoryProbeSpec[] {new RegisterMemoryProbeSpec("analysis-20260617-230913-176843-analysis-newstringutf-arg-read", "analysis-20260617-230913-176843-analysis-newstringutf-callsite", "enter", Arm64Const.UC_ARM64_REG_X1, "x1", 33, 0, "", 4096)}, new RegisterMemoryProbeSpec[] {});
    }
...
private void startTraceHooks() {
    stopTraceHooks();
    traceAiInstallRangeWriteProbeBreakpoint("analysis-20260617-230913-176843-analysis-sub9f4-output-writes", 0x8ecL, Arm64Const.UC_ARM64_REG_X1, "x1", 33, 0, "", 33);
}
