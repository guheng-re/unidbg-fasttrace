package agent.generated.nativesig_apk_e2e_20260812_202956;
...
public FileResult<AndroidFileIO> resolve(Emulator<AndroidFileIO> emulator, String pathname, int oflags) {
    ...
    private void installInstrumentation() {
            traceAiStartRangeWriteProbe("rw_srcbuf", 0x126240e0L, (0x126240e0L + 256L), traceAiRangeJson(0x126240e0L, (0x126240e0L + 256L), "fixed"));
            traceAiStartRangeWriteProbe("rw_finalbuf", 0x12624380L, (0x12624380L + 256L), traceAiRangeJson(0x12624380L, (0x12624380L + 256L), "fixed"));
        traceAiInstallBreakpoint("bp_nsutf2", "memoryReadOnBreakpoint", (0x12010bbcL - module.base), Arm64Const.UC_ARM64_REG_X1, "x1", new RegisterSpec[] {new RegisterSpec("x0", Arm64Const.UC_ARM64_REG_X0), new RegisterSpec("x1", Arm64Const.UC_ARM64_REG_X1), new RegisterSpec("x2", Arm64Const.UC_ARM64_REG_X2), new RegisterSpec("x3", Arm64Const.UC_ARM64_REG_X3), new RegisterSpec("x4", Arm64Const.UC_ARM64_REG_X4), new RegisterSpec("x5", Arm64Const.UC_ARM64_REG_X5), new RegisterSpec("x6", Arm64Const.UC_ARM64_REG_X6), new RegisterSpec("x7", Arm64Const.UC_ARM64_REG_X7), new RegisterSpec("lr", Arm64Const.UC_ARM64_REG_LR), new RegisterSpec("sp", Arm64Const.UC_ARM64_REG_SP), new RegisterSpec("pc", Arm64Const.UC_ARM64_REG_PC)}, 205, "memoryReadOnBreakpoint", 0L, 0L);
        traceAiInstallBreakpoint("bp_src2", "memoryReadOnBreakpoint", (0x12010bbcL - module.base), Arm64Const.UC_ARM64_REG_X0, "UC_ARM64_REG_X0", new RegisterSpec[] {new RegisterSpec("x0", Arm64Const.UC_ARM64_REG_X0), new RegisterSpec("x1", Arm64Const.UC_ARM64_REG_X1), new RegisterSpec("x2", Arm64Const.UC_ARM64_REG_X2), new RegisterSpec("x3", Arm64Const.UC_ARM64_REG_X3), new RegisterSpec("x4", Arm64Const.UC_ARM64_REG_X4), new RegisterSpec("x5", Arm64Const.UC_ARM64_REG_X5), new RegisterSpec("x6", Arm64Const.UC_ARM64_REG_X6), new RegisterSpec("x7", Arm64Const.UC_ARM64_REG_X7), new RegisterSpec("lr", Arm64Const.UC_ARM64_REG_LR), new RegisterSpec("sp", Arm64Const.UC_ARM64_REG_SP), new RegisterSpec("pc", Arm64Const.UC_ARM64_REG_PC)}, 205, "memoryReadOnBreakpoint", 0L, 0x126240e0L);
    }
