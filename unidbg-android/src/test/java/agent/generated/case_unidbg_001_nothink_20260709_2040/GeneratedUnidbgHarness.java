package agent.generated.case_unidbg_001_nothink_20260709_2040;
...
public class GeneratedUnidbgHarness extends AbstractJni implements IOResolver<AndroidFileIO> {
    ...
    private static final String SO_FILE_PATH = "D:\\project\\TraceAIagent_v3\\tests\\case_unidbg_001\\libs\\arm64-v8a\\libtraceai_case_001.so";
    private static final String PROCESS_NAME = "com.traceai.case001";
    ...
    public String run() {
        ...
        DvmObject<?> result = vm.resolveClass("com/traceai/case001/NativeEntry").callStaticJniMethodObject(emulator, "process(Ljava/lang/String;)Ljava/lang/String;", new StringObject(vm, "TraceAI case input"));
...
public FileResult<AndroidFileIO> resolve(Emulator<AndroidFileIO> emulator, String pathname, int oflags) {
    ...
    private void installInstrumentation() {
        traceAiInstallBreakpoint("read_pre_sprintf", "memoryReadOnBreakpoint", (0x12001160L - module.base), Arm64Const.UC_ARM64_REG_X0, "UC_ARM64_REG_X0", new RegisterSpec[] {new RegisterSpec("x0", Arm64Const.UC_ARM64_REG_X0), new RegisterSpec("x1", Arm64Const.UC_ARM64_REG_X1), new RegisterSpec("x2", Arm64Const.UC_ARM64_REG_X2), new RegisterSpec("x3", Arm64Const.UC_ARM64_REG_X3), new RegisterSpec("x4", Arm64Const.UC_ARM64_REG_X4), new RegisterSpec("x5", Arm64Const.UC_ARM64_REG_X5), new RegisterSpec("x6", Arm64Const.UC_ARM64_REG_X6), new RegisterSpec("x7", Arm64Const.UC_ARM64_REG_X7), new RegisterSpec("lr", Arm64Const.UC_ARM64_REG_LR), new RegisterSpec("sp", Arm64Const.UC_ARM64_REG_SP), new RegisterSpec("pc", Arm64Const.UC_ARM64_REG_PC)}, 32, "memoryReadOnBreakpoint", 0L, 0xe4fff6a8L);
        traceAiInstallBreakpoint("read_sprintf_fmt", "memoryReadOnBreakpoint", (0x12001160L - module.base), Arm64Const.UC_ARM64_REG_X0, "UC_ARM64_REG_X0", new RegisterSpec[] {new RegisterSpec("x0", Arm64Const.UC_ARM64_REG_X0), new RegisterSpec("x1", Arm64Const.UC_ARM64_REG_X1), new RegisterSpec("x2", Arm64Const.UC_ARM64_REG_X2), new RegisterSpec("x3", Arm64Const.UC_ARM64_REG_X3), new RegisterSpec("x4", Arm64Const.UC_ARM64_REG_X4), new RegisterSpec("x5", Arm64Const.UC_ARM64_REG_X5), new RegisterSpec("x6", Arm64Const.UC_ARM64_REG_X6), new RegisterSpec("x7", Arm64Const.UC_ARM64_REG_X7), new RegisterSpec("lr", Arm64Const.UC_ARM64_REG_LR), new RegisterSpec("sp", Arm64Const.UC_ARM64_REG_SP), new RegisterSpec("pc", Arm64Const.UC_ARM64_REG_PC)}, 16, "memoryReadOnBreakpoint", 0L, 0x1200065fL);
        traceAiInstallBreakpoint("read_sprintf_arg", "memoryReadOnBreakpoint", (0x12001160L - module.base), Arm64Const.UC_ARM64_REG_X0, "UC_ARM64_REG_X0", new RegisterSpec[] {new RegisterSpec("x0", Arm64Const.UC_ARM64_REG_X0), new RegisterSpec("x1", Arm64Const.UC_ARM64_REG_X1), new RegisterSpec("x2", Arm64Const.UC_ARM64_REG_X2), new RegisterSpec("x3", Arm64Const.UC_ARM64_REG_X3), new RegisterSpec("x4", Arm64Const.UC_ARM64_REG_X4), new RegisterSpec("x5", Arm64Const.UC_ARM64_REG_X5), new RegisterSpec("x6", Arm64Const.UC_ARM64_REG_X6), new RegisterSpec("x7", Arm64Const.UC_ARM64_REG_X7), new RegisterSpec("lr", Arm64Const.UC_ARM64_REG_LR), new RegisterSpec("sp", Arm64Const.UC_ARM64_REG_SP), new RegisterSpec("pc", Arm64Const.UC_ARM64_REG_PC)}, 16, "memoryReadOnBreakpoint", 0L, 0xe4fff4d0L);
    }
