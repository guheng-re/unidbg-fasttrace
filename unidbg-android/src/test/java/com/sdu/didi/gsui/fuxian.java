...
public class fuxian extends AbstractJni implements IOResolver<AndroidFileIO> {
    ...
    public String func_sig() {
        ...
        // baseline verification: traceCode disabled
    ...
    public DvmObject<?> callStaticObjectMethod(BaseVM vm, DvmClass dvmClass, String signature, VarArg varArg) {
        if (signature.equals("com/didi/security/wireless/SecurityLib->getFeature(I)Ljava/lang/Object;")) {
            if (varArg.getIntArg(0) == 8197) return new StringObject(vm, "com.sdu.didi.gsui");
            if (varArg.getIntArg(0) == 8198) return new StringObject(vm, "9.0.14");
            if (varArg.getIntArg(0) == 8195) return new StringObject(vm, "Android");
            if (varArg.getIntArg(0) == 8196) return new StringObject(vm, "10");
        }
    ...
    public FileResult<AndroidFileIO> resolve(Emulator<AndroidFileIO> emulator, String pathname, int oflags) {
        if (pathname.equals("/data/app/com.sdu.didi.gsui-mGlj-PzyfIpeLiDCnY-Qcw==/base.apk")) {
            File apk = new File("D:\\unidbg\\unidbg-0.9.8\\unidbg-android\\src\\test\\java\\com\\sdu\\didi\\gsui\\滴滴车主.apk");
    ...
    public static void main(String[] args) throws IOException {
        String soFilePath = "D:\\unidbg\\unidbg-0.9.8\\unidbg-android\\src\\test\\java\\com\\sdu\\didi\\gsui\\libdidiwsg.so";
